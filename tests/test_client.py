...
async def test_get_devices_name_resolution(
    ...
    """Test device name resolution priority: userDeviceName > friendlyName > deviceID."""
...
async def test_get_device_info_returns_description_and_serial(
    ...
    """Test that get_device_info parses description and serial number from the response."""
    mocked.post(
        JNAP_URL,
        payload={
            "result": "OK",
...
async def test_get_device_info_sends_correct_action(
    ...
    """Test that get_device_info sends the GetDeviceInfo action in the transaction body."""
    mocked.post(
        JNAP_URL,
        payload={
            "result": "OK",
...
async def test_unknown_action_raises_error(
    ...
    """Test that a top-level _ErrorUnknownAction response raises JNAPUnknownActionError."""
